...
const formWrapped = reduxForm({                       //it receives a single obj in which config can be given
    form: 'streamCreate',        //give any meaningful name...this is key for form
...
})(StreamCreate);   //redux-form works same as connect
